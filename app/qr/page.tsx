      ...
      <div className="max-w-2xl mx-auto px-4 py-8 pb-24 md:py-12">
        ...
        <div className="print:hidden mb-8">
          ...
          <div className="flex gap-2 mb-4">
            <Input value={url} onChange={(e) => setUrl(e.target.value)} placeholder="App URL" className={`font-mono text-sm ${isDark ? "bg-white/[0.06] border-white/10 text-white" : ""}`}/>
        ...
        <div className="mx-auto max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden print:shadow-none print:rounded-none print:max-w-full" style={{ printColorAdjust: "exact", WebkitPrintColorAdjust: "exact" }}>
          ...
          <div className="px-8 py-8 text-center">
            ...
            <div className="flex justify-center mb-6">
              <div className="p-4 bg-white rounded-2xl border-2 border-gray-100 inline-block">
                <img src={qrSrc} alt="QR Code" className="w-48 h-48 md:w-56 md:h-56" crossOrigin="anonymous"/>
              </div>
            </div>
        ...
        ].map((f) => (<div key={f.label} className="flex flex-col items-center gap-1">
