...
export default function AboutPage() {
    ...
    const sectionClass = `p-5 md:p-6 rounded-2xl border ${isDark ? "bg-white/[0.03] border-white/[0.06]" : "bg-white border-gray-100"}`;
    ...
    const codeClass = `px-3 py-3 rounded-xl text-xs ${isDark ? "bg-white/[0.04] border border-white/[0.06] text-white/80" : "bg-gray-50 border border-gray-100 text-gray-700"}`;
    ...
    return (<div className={`flex-1 overflow-y-auto ${isDark ? "bg-[#0a0a0f]" : "bg-gray-50"}`}>
      <div className="max-w-4xl mx-auto px-4 py-8 pb-24 md:py-12 space-y-5">
        ...
        <div className="text-center mb-2">
          <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-4 ${isDark ? "bg-indigo-500/10" : "bg-indigo-50"}`}>
        ...
        ].map((f) => (<div key={f.label} className={`flex flex-col items-center gap-2 py-3 rounded-xl ${isDark ? "bg-white/[0.03]" : "bg-gray-50"}`}>
        ...
        <div className={sectionClass}>
          ...
          <div className="grid gap-2">
            {TECH_STACK.map((tech) => (<div key={tech.name} className={`flex flex-col items-start gap-1.5 px-3 py-2.5 sm:flex-row sm:items-center sm:gap-3 rounded-xl ${isDark ? "bg-white/[0.03]" : "bg-gray-50"}`}>
