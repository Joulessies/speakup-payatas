...
const translations = {
    en: {
        ...
        trackDescription: "Enter your Anonymous ID to check the status of your reports.",
    ...
    fil: {
        ...
        trackDescription: "Ilagay ang iyong Anonymous ID para makita ang katayuan ng iyong ulat.",
